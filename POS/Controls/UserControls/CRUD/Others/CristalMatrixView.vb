...
#Region "Eventos de acción"
    ...
    Private Sub barManager_ItemClick(ByVal sender As Object, ByVal e As DevExpress.XtraBars.ItemClickEventArgs) Handles barManager.ItemClick
        ...
        ElseIf e.Item.Name = bbiCopiarWithHeaders.Name Then
...
#Region "Métodos Públicos"
    ...
    Public Sub ShowPreview()
        Try
            Using cl As New CompositeLink(New PrintingSystem())
                ...
                Try
                    ...
                    For Each item As XtraTabPage In tabControl.TabPages
                        pcl.Add(New PrintableComponentLink(cl.PrintingSystem))
...
#Region "Export"
    ...
    Private Sub ExportToCore(ByVal filename As [String], ByVal ext As String)
        ...
        If ext = "rtf" Then
            pivot.ExportToRtf(filename)
        End If
        If ext = "pdf" Then
            pivot.ExportToPdf(filename)
        End If
        If ext = "mht" Then
            pivot.ExportToMht(filename)
        End If
        If ext = "html" Then
            pivot.ExportToHtml(filename)
        End If
        If ext = "txt" Then
            pivot.ExportToText(filename)
        End If
        If ext = "xls" Then
...
#End Region
    ...
    Private Sub PegarDesdeExcel(ByVal grid As PivotGridControl, ByVal list As List(Of CristalValor))
        ...
        Try
            ...
            For rowIndex = cellSelection.Y To maxRow
                For colIndex = cellSelection.X To maxColumn
                    If rowIndex < excelTable.Rows.Count AndAlso colIndex < excelTable.Columns.Count Then
