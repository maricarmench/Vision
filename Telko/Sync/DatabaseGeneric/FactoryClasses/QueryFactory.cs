...
namespace Studio_Telko_Sync.FactoryClasses
{
	...
	public partial class QueryFactory
	{
		...
		/// <summary>Creates and returns a new EntityQuery for the MyDistribucionRegistro entity</summary>
		public EntityQuery<MyDistribucionRegistroEntity> DistribucionRegistro
		{
			get { return Create<MyDistribucionRegistroEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the MyEntitiyDistribucion entity</summary>
		public EntityQuery<MyEntitiyDistribucionEntity> EntitiyDistribucion
		{
			get { return Create<MyEntitiyDistribucionEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the MyEntityDistribucionAgregada entity</summary>
		public EntityQuery<MyEntityDistribucionAgregadaEntity> EntityDistribucionAgregada
		{
			get { return Create<MyEntityDistribucionAgregadaEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the MySubTentant entity</summary>
		public EntityQuery<MySubTentantEntity> SubTentant
		{
			get { return Create<MySubTentantEntity>(); }
		}

		/// <summary>Creates and returns a new EntityQuery for the MyTenant entity</summary>
		public EntityQuery<MyTenantEntity> Tenant
		{
			get { return Create<MyTenantEntity>(); }
		}
