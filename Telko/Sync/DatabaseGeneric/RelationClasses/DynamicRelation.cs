...
// Code is generated on: martes, 13 de abril de 2021 10:57:22
...
namespace Studio_Telko_Sync.RelationClasses
{
	...
	public class DynamicRelation : DynamicRelationBase
	{
		...
		/// <param name="onClause">The on clause for the join.</param>
		public DynamicRelation(DerivedTableDefinition leftOperand, JoinHint joinType, Studio_Telko_Sync.EntityType rightOperand, string aliasRightOperand, IPredicate onClause)
		{
		...
		/// <param name="aliasRightOperand">The alias of the right operand. If you don't want to / need to alias the right operand (only alias if you have to), specify string.Empty.</param>
		/// <param name="onClause">The on clause for the join.</param>
		public DynamicRelation(Studio_Telko_Sync.EntityType leftOperand, JoinHint joinType, Studio_Telko_Sync.EntityType rightOperand, string aliasLeftOperand, string aliasRightOperand, IPredicate onClause)
		{
