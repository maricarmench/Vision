...
Public Class DV_TallerDetailViewModuleFactory
    ...
    Public Function Create(ByVal parent As MainFormBase, ByVal listModule As IListViewModule, ByVal isNew As Boolean) As DetailViewModule Implements IDetailViewModuleFactory.Create
        Return New DetailViewModule(parent, New DV_TallerDetailView(listModule.ListViewToUse.BusinessEntity, listModule.ListViewToUse.DataSource))
    End Function
