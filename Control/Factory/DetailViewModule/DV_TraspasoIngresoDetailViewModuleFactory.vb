...
Public Class DV_TraspasoIngresoDetailViewModuleFactory
    ...
    Public Function Create(ByVal parent As MainFormBase, ByVal listModule As IListViewModule, ByVal isNew As Boolean) As DetailViewModule Implements IDetailViewModuleFactory.Create
        Return New TraspasoDetailViewModule(parent, New DV_TraspasoIngresoDetailView(listModule.ListViewToUse.BusinessEntity, listModule.ListViewToUse.DataSource))
    End Function
