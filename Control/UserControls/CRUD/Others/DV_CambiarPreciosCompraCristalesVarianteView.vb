...
Public Class DV_CambiarPreciosCompraCristalesVarianteView

    Private Sub ConfigParametros()

        lqsmsListaPreVenta.QueryableSource = (New ListaPreVtaBEntity).GetDataForComboAsQueryable()
        lqsmsMoneda.QueryableSource = (New MonedaBEntity).GetDataForComboAsQueryable()
        lqsmsLocal.QueryableSource = (New LocalBEntity).GetDataForComboAsQueryable()
    ...
    Private Sub btnCargar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnCargar.Click
        ...
        Try
            If DatosOk() Then
                ...
                Enabled = False
                Dim data As CristalesMatrixData = DV_CristalBEntity.GetMatrixData(Articulo_Local_ProveedorBEntity.GetByProveedorArticuloYMoneda(CInt(cboProveedorId.EditValue), CInt(cboMonedaId.EditValue), CInt(cboArticuloId.EditValue)))
                matrixView.Clear()
    ...
    Private Function DatosOk() As Boolean
        If cboArticuloId.EditValue Is Nothing Then
            ...
            Return False
        End If
        If cboProveedorId.EditValue Is Nothing Then
            MyMsgBox.Show("Debe seleccionar el proveedor.", MsgBoxStyle.Exclamation)
            Return False
        End If
        If cboMonedaId.EditValue Is Nothing Then
            ...
            Return False
        End If
        If cboLocalId.EditValue Is Nothing Then
            MyMsgBox.Show("Debe seleccionar el local.", MsgBoxStyle.Exclamation)
            Return False
        End If
        Return True
    End Function
    ...
    Private Sub btnGuardar_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnGuardar.Click
        ...
        Try
            ...
            DV_CristalBEntity.SaveMatrixDataPreciosCompra(data, CInt(cboProveedorId.EditValue), CInt(cboMonedaId.EditValue), CInt(cboArticuloId.EditValue), CInt(cboLocalId.EditValue))
    ...
    Private Sub parametros_EditValueChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles cboArticuloId.EditValueChanged, cboMonedaId.EditValueChanged, cboProveedorId.EditValueChanged
        ChangeViewMode(ViewMode.Consulta)
    End Sub
