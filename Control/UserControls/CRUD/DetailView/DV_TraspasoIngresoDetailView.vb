...
Public Class DV_TraspasoIngresoDetailView
    ...
    Public Sub New(ByVal business As TraspasoBentity, ByVal binding As BindingSource)
    ...
    Private Sub OnProcessGridKey(ByVal sender As Object, ByVal e As KeyEventArgs)
        If e.KeyCode = Keys.F11 AndAlso CurrentEntity.IsNew _
            AndAlso cboDepositoIdOrigen.EditValue IsNot Nothing _
            AndAlso cboDepositoIdDestino.EditValue IsNot Nothing Then
            ShowCristalForm()
        End If
    End Sub
    ...
    Private Sub ShowCristalForm()
        ...
        Try
            ...
            End If
            Dim dsSource As CristalesMatrixData = DV_CristalBEntity.GetMatrixData(GetCurrentEntity(Of TraspasoEntity).Detalles)
                ...
                Try
                    ...
                    Using f As New Studio.Net.Controls.[New].Forms.SaveDeleteGenericDialog(v)
                        ...
                        If f.ShowDialog(_parent) = Windows.Forms.DialogResult.OK Then
                            DV_CristalBEntity.UpdateMatrixData(dsSource, GetCurrentEntity(Of TraspasoEntity).Detalles)
                        End If
                    End Using
                Catch
                    Throw
    ...
    Private Sub OnGetQueryableForArticulo(ByVal sender As Object, ByVal e As CristalMatrixView.MatrixViewGetQueryableEvenArgs)
        e.QueryableSource = DV_CristalBEntity.GetQueryableForCristalesGuiaDeVariante(e.Adapter, CInt(cboDepositoIdOrigen.EditValue), CInt(cboDepositoIdDestino.EditValue))
        e.Handled = True
    End Sub
