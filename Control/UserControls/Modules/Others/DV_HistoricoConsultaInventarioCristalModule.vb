...
Public Class DV_HistoricoConsultaInventarioCristalModule
...
#Region "Procedimientos Privados"
    ...
    Private Sub ShowConsultaMovimiento(data As CristalValor)
        ...
        Dim m As New ConsultaMovimientoArticuloTaskPanelModule(data.ArticuloId, CInt(cboDepositoId.EditValue), txtFecha.DateTime.AddDays(1)) With {.ListViewToUse = New ConsultaMovimientoDynamicTabularListView()}
    ...
    Private Function GetMatrixData() As List(Of CristalData)
        ...
        For Each cristal As DV_CristalEntity In DV_CristalBEntity.GetDataForControlStockAFecha(GetSelectedCristales(), CInt(cboDepositoId.EditValue), txtFecha.DateTime)
            ...
            For Each variante As DV_CristalEntity In cristal.Variantes
                ...
                Dim valor As New CristalValor With {
                                    .ArticuloId = variante.Id, .NoExiste = False,
                                    .PlantillaValorID1 = variante.CombinacionesDeVariante(0).AAtributoPlantillaValorID,
                ...
                'If variante.Stock.Count > 0 Then
                    valor.Valor = variante.Movimientos.Sum(Function(f) f.Cantidad)
                'End If
    ...
    Private Function DatosOK() As Boolean
        Return cboDepositoId.EditValue IsNot Nothing AndAlso txtFecha.EditValue IsNot Nothing 'AndAlso chkCristales.Properties.GetCheckedItems()
    End Function
    ...
    Private Sub ConfigParametros()
        ...
        txtFecha.EditValue = System.DateTime.Today
