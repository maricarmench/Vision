...
Public Class DV_ConsultaInventarioCristalModule
...
#Region "Procedimientos Privados"
    ...
    Private Function GetMatrixData() As List(Of CristalData)
        ...
        For Each cristal As DV_CristalEntity In DV_CristalBEntity.GetDataForControlStock(GetSelectedCristales(), CInt(cboDepositoId.EditValue))
            ...
            For Each variante As DV_CristalEntity In cristal.Variantes
                ...
                If variante.Stock.Count > 0 Then
                    valor.Valor = variante.Stock(0).Stock
                End If
    ...
    Private Function DatosOK() As Boolean
        Return cboDepositoId.EditValue IsNot Nothing 'AndAlso chkCristales.Properties.GetCheckedItems()
    End Function
